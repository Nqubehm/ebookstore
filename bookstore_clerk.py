...
#Print all books inside the database

conn = mysql.connector.connect(host='localhost',user='root',database='ebookstore',password='$ecurePa$$1!')
cursor = conn.cursor()
...
class BookStore:
    ...
    def searchBook(self,Id=0,Author=""):
...
def user_menu():
    ...
    if user_choice ==1:
        ...
        if Id_title_author.isnumeric():
            print(book.searchBook(Id_title_author))
        else:
            print(book.searchBook(Author=Id_title_author))
